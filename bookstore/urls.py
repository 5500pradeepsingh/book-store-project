...
urlpatterns = [
    ...
    url(r'^book/(?P<bid>[a-zA-Z0-9]+)/review-filter-newest/(?P<rnum>[0-9]+)', views.review_filter_newest,
        name='review_filter_newest'),
    url(r'^book/(?P<bid>[a-zA-Z0-9]+)/review-filter-best/(?P<rnum>[0-9]+)', views.review_filter_best,
        name='review_filter_best'),
    ...
    url(r'^sai/(?P<bid>[a-zA-Z0-9]+)', views.book_details, name='book_details'),
    url(r'^sai/', views.add_to_cart, name='add_to_cart'),
