...
def sai(request):
    return render(request, 'bookstore/sai.html')
            ...
            for b in books_in_cart:
                if item.isbn13.isbn13 == b.isbn13:
                    try:
                        ...
                        print ('excepted yo')
                        book_img = 'https://cdn5.vectorstock.com/i/thumb-large/99/64/open-book-cartoon-symbol-icon-design-beautiful-vector-17379964.jpg'
                    finally:
